		          		...
		          		<form action="controller/product.php" method="post" enctype="multipart/form-data">
		          			...
		          			<div class="row">
		    							<div class="col-md-6 mb-2">
		      							...
		      							<input type="text" class="form-control " name="product_name" id="" size="20" required>
		    							</div>
		    							<div class="col-md-6 mb-2">
		     								<label >GST %</label>
		      								<input type="number" class="form-control" name="gst_no" style="width:80px" >
		    							</div>
		    						</div>
		    						<div class="row">
		    							<div class="col-md-6 mb-2">
		    							...
		    							<div class="col-md-6 mb-2">
		      							...
		      							<select name="discount" class="form-control" style="width:80px">
		    						...
		    						<div class="row">
			    						...
			    						<div class="col-md-6 mb-2">
			     								<label >QTY (%)</label>
			      							<input type="text" class="form-control" name="req_percentage[]"  style="width: 120px;" required>
			    						</div>
			    					...
			    					<div class="row">
			    						<table width="100%">
												...
												<td><input id="aiq10" onclick="onAiqCheck(10)" type="checkbox" name="aiq[]" value="10" <?php 
													 ...
													 ?> > 10 &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('10', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="mrp10" class="form-control hide" type="number" name="mrp[]" value ="<?php 
														if(in_array('10', $aiq_array) == true) {
															$a = array_search('10', $aiq_array);
															echo trim($mrp_array[$a]); 
														} 
													 ?>" ></td>
													 <td><input <?php if(in_array('10', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="rate10" class="form-control hide" type="number" name="rate[]" value ="<?php 
														if(in_array('10', $aiq_array) == true) {
															$a = array_search('10', $aiq_array);
													 ...
													 ?> > 50 &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('50', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="mrp50" class="form-control hide" type="number" name="mrp[]" value ="<?php 
														if(in_array('50', $aiq_array) == true) {
															$a = array_search('50', $aiq_array);
															echo trim($mrp_array[$a]); 
														} 
													 ?>" ></td>
													 <td><input <?php if(in_array('50', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="rate50" class="form-control hide" type="number" name="rate[]" value ="<?php 
														if(in_array('50', $aiq_array) == true) {
															$a = array_search('50', $aiq_array);
															echo trim($rate_array[$a]); 
														} 
												...
												<td><input id="aiq100" onclick="onAiqCheck(100)" type="checkbox" name="aiq[]" value="100" <?php 
													 ...
													 ?> > 100 &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('100', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="mrp100" class="form-control hide" type="number" name="mrp[]" value ="<?php 
														if(in_array('100', $aiq_array) == true) {
															$a = array_search('100', $aiq_array);
															echo trim($mrp_array[$a]); 
														} 
													 ?>" ></td>
													 <td><input <?php if(in_array('100', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="rate100" class="form-control hide" type="number" name="rate[]" value ="<?php 
														if(in_array('100', $aiq_array) == true) {
															$a = array_search('100', $aiq_array);
															echo trim($rate_array[$a]); 
														} 
													...
													<td><input id="aiq250" onclick="onAiqCheck(250)" type="checkbox" name="aiq[]" value="250" <?php 
													 ...
													 ?> > 250 &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('250', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="mrp250" class="form-control hide" type="number" name="mrp[]" value ="<?php 
														if(in_array('250', $aiq_array) == true) {
															$a = array_search('250', $aiq_array);
															echo trim($mrp_array[$a]); 
														} 
													 ?>" ></td>
													 <td><input <?php if(in_array('250', $aiq_array) == true) { echo "enable"; } else { echo "disabled"; } ?>  id="rate250" class="form-control hide" type="number" name="rate[]" value ="<?php 
														if(in_array('250', $aiq_array) == true) {
															$a = array_search('250', $aiq_array);
															echo trim($rate_array[$a]); 
														} 
												...
												<tr>
													<td><input id="aiq200" onclick="onAiqCheck(200)" type="checkbox" name="aiq[]" value="200" 
													 ...
													 ?>> 200  &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('200', $aiq_array) != true) { echo "disabled"; }  ?> id="mrp200" class="form-control hide" type="text" name="mrp[]" value ="<?php 
														if(in_array('200', $aiq_array) == true) {
															$a = array_search('200', $aiq_array);
															echo trim($mrp_array[$a]);
														} 
													 ?>" ></td>
													 <td><input <?php if(in_array('200', $aiq_array) != true) { echo "disabled"; }  ?> id="rate200" class="form-control hide" type="text" name="rate[]" value ="<?php 
														if(in_array('200', $aiq_array) == true) {
															$a = array_search('200', $aiq_array);
															echo trim($rate_array[$a]);
														} 
												...
												<tr>
													<td><input id="aiq500" onclick="onAiqCheck(500)" type="checkbox" name="aiq[]" value="500" <?php 
													 ...
													 ?>> 500  &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('500', $aiq_array) != true) { echo "disabled"; }  ?> id="mrp500" class="form-control hide" type="text" name="mrp[]" value ="<?php 
														if(in_array('500', $aiq_array) == true) {
												...
												<tr>
													<td><input id="aiq1000" onclick="onAiqCheck(1000)" type="checkbox" name="aiq[]" value="1000" <?php 
													 ...
													 ?>> 1000  &nbsp; &nbsp; </td>
													<td><input <?php if(in_array('1000', $aiq_array) != true) { echo "disabled"; }  ?> id="mrp1000" class="form-control hide" type="text" name="mrp[]" value ="<?php 
														if(in_array('1000', $aiq_array) == true) {
													 ...
													 ?>"></td>
													 <td><input <?php if(in_array('1000', $aiq_array) != true) { echo "disabled"; }  ?> id="rate1000" class="form-control hide" type="text" name="rate[]" value ="<?php 
														if(in_array('1000', $aiq_array) == true) {
															$a = array_search('1000', $aiq_array);
															echo trim($rate_array[$a]); 
															//echo $mrp_array[0];
